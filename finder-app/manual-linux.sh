...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    # make ARCH=arm64 CROSS_COMPILE=aarch64-none-linux-gnu- INSTALL_MOD_PATH=${OUTDIR}/linux-stable/modules_install INSTALL_FW_PATH=${OUTDIR}/linux-stable/firmware modules_install   
fi
...
cp -r -L ${FINDER_APP_DIR}/conf ${OUTDIR}/rootfs/home/ 
